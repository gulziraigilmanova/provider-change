...
knitr::kable(table(data_inpatient$from, data_inpatient$to), caption = "Table 2.a. Inpatient Stay - Complete")
...
knitr::kable(table(data_daypatient$from, data_daypatient$to), caption = "Table 2.d. Daypatient Care - Complete")
